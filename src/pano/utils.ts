...
import type { PositionAble } from "./type";
...
export const applyElementPosition = (
  ...
  const align = alignOverride ?? data.align;
  ...
  if (align === "center" || data.edge === "center") {
    ...
    if (align === "top" || data.edge === "top") element.style.top = "0px";
    if (align === "bottom" || data.edge === "bottom")

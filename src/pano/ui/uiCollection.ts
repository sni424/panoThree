import type Core from "@/pano/core";
...
function uiCollection(core: Core) {
  createRoomList(roomList, core);
  createModal();
}

function createRoomList(roomInfo: typeof roomList, core: Core) {
...
function createModal() {
  ...
  const contentDiv = createModalContent();

 ...
 */
import type { LoginPageSettings, TextData } from "@/pano/type";
import "../css/login.css";
import { applyElementPosition, hexToRgba } from "@/pano/utils";
...
export const login2 = (loginData: LoginPageSettings) => {
  ...
  loginButton.addEventListener("click", () => {
    // 로그인 검증 로직 성공 후 이동
    window.location.href = "/pano?pid=bongmyeong&page=estimate/type";
  });
};
